...
const PopupWeatherItem = ({ active, setActive, day, city }) => {
    ...
    return (
        <div
            className={active ? "popup-wrapper" : "none"}
            onMouseDown={() => setActive(false)}
        >
            <div
                className="this-day-info popup-weather-item"
            ...
            >
                ...
                <div className="wrapper">
                    ...
                    <div className="this-day-info__item">
                        ...
                        <span>Давление</span>
                        <div className="this-day-info__item__text">
                            {pressureMmHg} мм ртутного столба
                        </div>
                    </div>
                    <div className="this-day-info__item">
                        <div className="this-day-info__item__icon">
                        ...
                        <div className="this-day-info__item__text">
                            {precipitation_sum
                                ? precipitation_sum.toFixed(1) + " мм"
                                : "" || "Без осадков"}
                        </div>
                    </div>
                    <div className="this-day-info__item">
                        ...
                        <span>Ветер</span>
                        <div className="this-day-info__item__text">
                            {wind_speed_10m_max.toFixed(1)} м/с {windDirection}{" "}
                            - {windSpeed}
                        </div>
                    </div>
                </div>
